                    ...
                    <div class="table-list clearfix">
                        <table id="dg" title="" style="height:250px"
                            ...
                            <tr>
                                ...
                                <th data-options="field:'maker',width:60,align:'center'">产品状态</th>
...
$(function(){
	$("#addsomepro").click(function(){
		parent.TabControlAppend("2-0-1", "产品审核详情页", "webpage/peripheralproduct/peripheral_aduit/son/peripheral_aduit_son_basic_info.jsp");
